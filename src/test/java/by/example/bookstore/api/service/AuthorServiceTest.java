...
//
//import by.example.bookstore.api.mapper.AuthorMapper;
...
//import by.example.bookstore.api.repository.AuthorRepository;
...
//    when(authorRepository.existsByLastnameAndName(
...
//        .existsByLastnameAndName(authorRequestDto.name(), authorRequestDto.lastname());
...
//        assertThrows(IllegalArgumentException.class, () -> authorService.save(authorRequestDto));
//
//    assertEquals(
//        String.format(
//            "Author '%s %s' already exists", authorRequestDto.name(), authorRequestDto.lastname()),
